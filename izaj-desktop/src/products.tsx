      ...
      <div className="max-w-7xl mx-auto bg-white rounded-3xl shadow-2xl border border-white p-8 mb-8"
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-4">
            ...
            <button
              className={`flex items-center gap-1 ${filter === 'sale' ? 'text-black font-semibold border-b-2 border-black' : 'text-gray-500 hover:text-black border-b-2 border-transparent'}`}
