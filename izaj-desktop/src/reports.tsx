  ...
  return (
    <main className="flex-1 px-8 py-8 bg-gray-50 overflow-auto">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        <div className="bg-white rounded-2xl shadow-lg border-l-4 border-sky-300 p-6 flex flex-col items-center hover:scale-[1.025] transition-transform">
          <Icon icon="mdi:cash-multiple" className="w-10 h-10 text-sky-400 mb-3" />
          <span className="text-2xl font-bold text-gray-800">₱ 1,111,111</span>
          <span className="text-gray-500 text-sm">Total Sales Revenue</span>
        </div>
        <div className="bg-white rounded-2xl shadow-lg border-l-4 border-yellow-300 p-6 flex flex-col items-center hover:scale-[1.025] transition-transform">
          <Icon icon="mdi:package-variant-closed" className="w-10 h-10 text-yellow-400 mb-3" />
          <span className="text-2xl font-bold text-gray-800">Plug In Pendant Light</span>
          <span className="text-gray-500 text-sm">Best Product</span>
        </div>
        <div className="bg-white rounded-2xl shadow-lg border-l-4 border-pink-300 p-6 flex flex-col items-center hover:scale-[1.025] transition-transform">
          <Icon icon="mdi:box" className="w-10 h-10 text-pink-400 mb-3" />
          <span className="text-2xl font-bold text-gray-800">Pendant Light</span>
          <span className="text-gray-500 text-sm">Best Category</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg border-l-4 border-sky-200 p-6 flex flex-col hover:scale-[1.01] transition-transform">
          <div className="flex items-center gap-2 mb-6">
            ...
            <select className="text-sm text-gray-500 border border-gray-300 rounded px-3 py-1 bg-white ml-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg border-l-4 border-green-200 p-6 flex flex-col items-center hover:scale-[1.01] transition-transform">
            ...
            <span className="text-5xl font-bold text-center my-auto">123</span>
          </div>
          {/* Stock Level */}
