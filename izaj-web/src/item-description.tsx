...
<div className="mb-8 border-b border-gray-200 pb-6">
  ...
  {isDeliveryOpen && (
    <div className="max-h-64 overflow-y-auto"> {/* Added scrollable container */}
      <div className="space-y-4 pr-2"> {/* Added padding for scrollbar */}
...
<div className="mb-8 border-b border-gray-200 pb-6">
  ...
  {isCareOpen && (
    <div className="max-h-64 overflow-y-auto"> {/* Added scrollable container */}
      <div className="border-t border-gray-200 pt-4 space-y-4 pr-2"> {/* Added padding for scrollbar */}
...
<div className="mt-12 max-w-7xl mx-auto">
  ...
  <div className="border border-black rounded-lg p-6 shadow-sm relative">
    ...
    <div className="absolute bottom-4 right-4">
      <button className="text-sm text-grey-500 hover:underline">View More</button>
    </div>
  </div>
</div>
        {/* Feature Section */}
