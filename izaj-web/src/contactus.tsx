     ...
     <div className="flex flex-col min-h-screen">
       ...
       <header className="bg-white px-10 py-3 flex flex-col ">
        ...
        <nav className="bg-white py-3">
          <ul className="flex justify-center space-x-10 text-sm font-medium">
            ...
            <li><Link to="/contactus" className="text-black hover:border-b-2 border-black pb-1">ABOUT US</Link></li>
          </ul>
        </nav>
      </header>
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto bg-white p-10 rounded-2xl shadow-lg text-center">
          <h1 className="text-4xl font-extrabold text-gray-800 mb-8 tracking-wide">Contact Us</h1>
          
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            <div>
              <p className="font-semibold text-black">Izaj Lighting Centre</p>
              <p>San Pablo, 173.1 San Pablo City, 4000 Laguna</p>
            </div>
            
            <div className="space-y-3">
              <p><span className="font-semibold text-black">VIBER:</span> +639123456789</p>
              <p><span className="font-semibold text-black">FACEBOOK:</span> IZAJ LIGHTNING CENTRE</p>
              <p><span className="font-semibold text-black">WHATSAPP:</span> +639123456789</p>
              <p><span className="font-semibold text-black">PHONE:</span> +639123456789</p>
              <p><span className="font-semibold text-black">TELEPHONE:</span> (02)123456</p>
              <p><span className="font-semibold text-black">EMAIL:</span> example@small.com</p>
            </div>
