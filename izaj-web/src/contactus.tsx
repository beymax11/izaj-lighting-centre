    ...
    <main className="flex-grow container mx-auto px-4 py-8">
     <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-sm text-center">
       ...
       <div className="space-y-6 text-lg">
         <div>
        <p className="font-semibold">Izaj Lighting Centre</p>
        <p>San Pablo, 173.1 San Pablo City, 4000 Laguna</p>
         </div>
         
         <div className="space-y-2">
        <p><span className="font-semibold">VIBER:</span> +639123456789</p>
        <p><span className="font-semibold">FACEBOOK:</span> IZAJ LIGHTNING CENTRE</p>
        <p><span className="font-semibold">WHATSAPP:</span> +639123456789</p>
        <p><span className="font-semibold">PHONE:</span> +639123456789</p>
        <p><span className="font-semibold">TELEPHONE:</span> (02)123456</p>
        <p><span className="font-semibold">EMAIL:</span> example@small.com</p>
         </div>
