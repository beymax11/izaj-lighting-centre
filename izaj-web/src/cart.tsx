...
const Cart: React.FC = () => {
  return (
    <div className="container mx-auto p-6">
      <Header />
      <NavigationBar />
      <h1 className="text-3xl font-semibold text-black mb-6">Shopping Cart</h1>

      {/* Shopping Cart Table */}
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white table-auto border-separate border-spacing-0 border border-gray-300">
          <thead>
            <tr className="text-left">
              <th className="p-4 border-b border-gray-200">PRODUCT</th>
              <th className="p-4 border-b border-gray-200">UNIT PRICE</th>
              <th className="p-4 border-b border-gray-200">QUANTITY</th>
              <th className="p-4 border-b border-gray-200">TOTAL PRICE</th>
            ...
            <tr>
              <td className="p-4 border-b border-gray-200">
                <div className="flex items-center">
                  <img
                    src="ceiling-light.jpg" // Replace with actual product image
                    alt="Aberdeen Modern LED Chandelier"
                    className="w-20 h-20 object-cover rounded-lg"
                  />
                  <div className="ml-4">
                    <p className="text-sm font-semibold">Aberdeen | Modern LED Chandelier</p>
                    <p className="text-xs text-gray-500">Monthly Deals + ₱1,000</p>
                  </div>
                </div>
              </td>
              <td className="p-4 border-b border-gray-200">₱15,995</td>
              <td className="p-4 border-b border-gray-200">
                <input
                  type="number"
                  value="1"
                  min="1"
                  className="w-16 p-2 border rounded-md border-gray-300 text-center"
                />
              </td>
              <td className="p-4 border-b border-gray-200">₱15,995</td>
              <td className="p-4 border-b border-gray-200">
      ...
      {/* Cart Summary */}
      <div className="mt-6 flex justify-between items-center bg-gray-100 p-6 rounded-lg">
        <div>
          <h3 className="text-lg font-semibold text-black">Total</h3>
          <p className="text-sm text-gray-600">You saved ₱1,089!</p>
        </div>
        <div>
          <p className="text-xl font-bold text-black">₱15,995</p>
          <Link to="/checkout">
  <button className="mt-4 w-full py-2 bg-black text-white font-semibold rounded-lg hover:bg-gray-800 transition-all duration-300">
    CHECKOUT
  </button>
</Link>
