...
import { faSearch, faBell, faShoppingCart, faCaretDown, faClipboardList, faUser, faCreditCard, faWallet } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="w-full md:w-64 bg-white border border-black p-4">
              <div className="flex flex-col items-center justify-center">
                ...
                <ul className="w-full">
                  ...
                  <li className="pl-8 py-1.5">
                    <Link to="/banks-cards" className="text-black font-medium text-sm block">Banks & Cards</Link>
                  </li>
                  <li className="pl-8 py-1.5">
                    <Link to="/addresses" className="text-gray-600 hover:text-black text-sm block">Addresses</Link>
                  </li>
                  <li className="pl-8 py-1.5">
                    <a href="#change-password" className="text-gray-600 hover:text-black text-sm block">Change Password</a>
                  </li>
                ...
                <div className="p-6">
                  ...
                  {activeTab === 'E-Wallet' && (
                    <div>
                      ...
                      <div className="text-center py-12 bg-gray-50 rounded">
                        <p className="text-gray-600">You don't have any e-wallets yet.</p>
                      </div>
                    </div>
                  )}
                </div>
