        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 lg:gap-24">
            ...
            <div className="lg:col-span-1">
              ...
              <Link to="/subscribe" className="bg-black text-white text-sm md:text-base font-semibold rounded-full px-6 md:px-8 py-2 md:py-3 hover:bg-gray-800 transition-colors inline-block">Join for free</Link>
            </div>
